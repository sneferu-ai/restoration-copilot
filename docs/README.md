...
|---|---|
| [specification/SPECIFICATION.md](specification/SPECIFICATION.md) | The frozen product contract (B13): FR/AC requirements, data model, REST table, pinned formulas. |
...
- **Maintainer:** [ARCHITECTURE.md](ARCHITECTURE.md) → [../IMPLEMENTATION_NOTES.md](../IMPLEMENTATION_NOTES.md) → [specification/SPECIFICATION.md](specification/SPECIFICATION.md) → [OPERATIONS.md — troubleshooting](OPERATIONS.md#troubleshooting).
...
- FR-/AC- numbers cite the frozen spec ([specification/SPECIFICATION.md](specification/SPECIFICATION.md)); file paths cite the source of truth directly.
